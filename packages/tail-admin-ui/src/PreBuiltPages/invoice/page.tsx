      ...
      <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-9">
        <div className="flex flex-col-reverse gap-5 xl:flex-row xl:justify-between">
          <div className="flex flex-col gap-4 sm:flex-row xl:gap-9">
            <div>
              <p className="mb-1.5 text-lg font-medium text-black dark:text-white">From</p>
            ...
            <div>
              <p className="mb-1.5 text-lg font-medium text-black dark:text-white">To</p>
              <h4 className="mb-4 text-2xl font-semibold text-black dark:text-white">Cristofer Levin</h4>
              <a href="#" className="block">
                <span className="font-medium">Email:</span> contact@example.com
              </a>
              <span className="mt-2 block">
                <span className="font-medium">Address:</span> New York, USA 2707 Davis Anenue
              </span>
            </div>
          </div>
          <h3 className="text-2xl font-semibold text-black dark:text-white">Order #15478</h3>
        </div>
          ...
          <div className="items-center sm:flex">
            ...
            <div className="w-full items-center justify-between md:flex">
              ...
              <div className="flex items-center md:justify-end">
                <p className="mr-20 font-semibold text-black dark:text-white">Qty: 01</p>
                <p className="mr-5 font-semibold text-black dark:text-white">$120.00</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 xl:w-3/12">
            <div className="mb-10">
              <h4 className="mb-4 text-xl font-semibold text-black dark:text-white md:text-2xl">Shipping Method</h4>
              <p>
          ...
          <div className="w-full px-4 sm:w-1/2 xl:w-3/12">
            <div className="mb-10">
              <h4 className="mb-4 text-xl font-semibold text-black dark:text-white md:text-2xl">Payment Method</h4>
              <p>
