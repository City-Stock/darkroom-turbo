...
import CardsItemOne from "@/TailAdminComponents/cards/CardsItemOne";
import CardsItemTwo from "@/TailAdminComponents/cards/CardsItemTwo";
import CardsItemThree from "@/TailAdminComponents/cards/CardsItemThree";
...
const Cards: React.FC = () => {
  return (
    <>
      ...
      <h2 className="mt-10 mb-7.5 text-title-md2 font-semibold text-black dark:text-white">Cards</h2>

      <div className="grid grid-cols-1 gap-7.5 sm:grid-cols-2 xl:grid-cols-3">
        {cardsItemTwoData.map((card, key) => (
          <CardsItemTwo key={key} cardImageSrc={card.cardImageSrc} cardTitle={card.cardTitle} cardContent={card.cardContent} />
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 gap-7.5 sm:grid-cols-2 xl:grid-cols-3">
        {cardsItemThreeData.map((card, key) => (
          <CardsItemThree key={key} cardTitle={card.cardTitle} cardContent={card.cardContent} />
        ))}
      </div>
    </>
  );
