...
import InboxMenuList from "@/TailAdminComponents/Inbox/InboxMenuList";
import InboxList from "@/TailAdminComponents/Inbox/InboxList";
        ...
        <div className="h-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark lg:flex">
          ...
          >
            ...
            <div className="px-4 pt-4">
              <button className="flex w-full rounded-md bg-primary py-2.5 px-5.5 font-medium text-white">Compose</button>
            </div>
          ...
          <div className="flex h-full flex-col border-l border-stroke dark:border-strokedark lg:w-4/5">
            ...
            <div className="flex flex-col-reverse justify-between gap-6 py-4.5 pl-4 pr-4 sm:flex-row lg:pl-10 lg:pr-7.5">
              <div className="flex items-center gap-4">
                <label htmlFor="checkboxAll" className="flex cursor-pointer select-none items-center font-medium">
                  <div className="relative">
                    <input type="checkbox" id="checkboxAll" className="tableCheckbox sr-only" />
              ...
              <div className="relative">
                ...
                <span className="absolute left-0 top-1/2 -translate-y-1/2">
                  <svg className="fill-[#637381] hover:fill-primary" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
            ...
            <div className="flex items-center justify-between border-t border-stroke p-4 dark:border-strokedark sm:px-6">
              <p className="text-base font-medium text-black dark:text-white md:text-lg">1-5 of 29</p>
