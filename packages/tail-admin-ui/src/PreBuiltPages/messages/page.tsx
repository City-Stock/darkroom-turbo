            ...
            <div className="flex max-h-full flex-col overflow-auto p-5">
              ...
              <div className="no-scrollbar max-h-full space-y-2.5 overflow-auto">
                ...
                {chatList.map((object, item) => {
                  return (
                    <div key={item} className="flex cursor-pointer items-center rounded py-2 px-4 hover:bg-gray-2 dark:hover:bg-strokedark">
                      <div className="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                        <Image src={object.imgSrc} alt="profile" className="h-full w-full object-cover object-center" width={44} height={44} />
            ...
            <div className="sticky flex items-center justify-between border-b border-stroke px-6 py-4.5 dark:border-strokedark">
              <div className="flex items-center">
                <div className="mr-4.5 h-13 w-full max-w-13 overflow-hidden rounded-full">
                  <Image src={"/images/user/user-01.png"} alt="avatar" className="h-full w-full object-cover object-center" width={52} height={52} />
                </div>
                <div>
